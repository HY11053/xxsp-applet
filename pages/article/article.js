    ...
    formSubmitHandle: function(e) {
        ...
        swan.request({
            ...
            data:{
                ...
                host:'http://mip.xiuxianshipin.com/index.php/news/'+that.data.thisarticleinfos.id+'/?referer=baidu_applet',
    ...
    formSubmitHandle2: function(e) {
        ...
        swan.request({
            ...
            data:{
                ...
                host:'http://mip.xiuxianshipin.com/index.php/news/'+that.data.thisarticleinfos.id+'/?referer=baidu_applet-mod',
                realm:'mip.51xxsp.com',
                job:'guestbook',
                title:'火爆餐饮网',
                cla:that.data.thisarticleinfos.brandtypename,
